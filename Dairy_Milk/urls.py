...
from django.contrib import admin
from django.urls import path, include
from accounts.views import Systemusers
from Dairy_Milk.views import home_page, contact_page
from products import views
from products.views import search_product,New_arraivals,product_detail,total_data,OneData,FarmData
from orders.views import deliveryboy_page,deliveryboyLogin,deliverboy
...
urlpatterns = [
    ...
    path('milk',include('Milk.urls'),name='milk'),
    ...
    path('deliveryboylist',deliveryboy_page,name="deliveryboylist"),
    path("deliveryboyLogin",deliveryboyLogin,name="deliveryboy_page"),
    path("deliveryorders",deliverboy,name="deliveryorders"),
    path("sytemusers",Systemusers,name="sytemusers"),
    path("newarravals",New_arraivals,name="newarravals"),
    path('products1',views.product_view,name='products1'),
    path('getdata',views.total_data,name='getdata'),
    path('onedata',views.OneData,name='onedata'),
    path('farmdata',views.FarmData,name='farmdata'),
    path('ordata',views.Order_Data,name='ordata'),
